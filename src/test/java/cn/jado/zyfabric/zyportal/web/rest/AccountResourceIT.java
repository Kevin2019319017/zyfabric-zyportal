...
import static cn.jado.zyfabric.zyportal.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static cn.jado.zyfabric.zyportal.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static cn.jado.zyfabric.zyportal.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import cn.jado.zyfabric.zyportal.IntegrationTest;
import cn.jado.zyfabric.zyportal.security.AuthoritiesConstants;
