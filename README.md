...
To build the final jar and optimize the zyportal application for production, run:
...
Then navigate to [http://localhost:10080](http://localhost:10080) in your browser.
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v8.7.0/doing-api-first-development/
